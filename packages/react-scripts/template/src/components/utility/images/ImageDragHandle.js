...
const ImageDragHandle = (props) => {
	return (
		<svg className="image-drag-handle" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10" height="16" viewBox="0 0 10 16">
			<g className={"image-fill image-fill-" + props.fill}>
